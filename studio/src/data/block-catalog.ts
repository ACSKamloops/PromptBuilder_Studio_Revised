...
export const blockCatalog: BlockDescriptor[] = [
  ...
  },
  {
    ...
    benchmarks: [
      { name: "Self-Refine", score: "91", tier: "gold" },
    ],
  },
  {
    id: "approval-gate",
  ...
  },
  {
    ...
    category: "Evaluation",
    description:
      "Run perturbation sweeps to measure prompt stability and trigger AutoPrompt mitigation when variance spikes.",
    status: "available",
    metadataId: "psa-sweep",
    references: ["prompts/prompt-sensitivity-analysis.yaml"],
    guardrails: ["Baseline prompt required", "Perturbation axes logged for reproducibility"],
    benchmarks: [
      { name: "Stability score", score: "Alerts <0.85", tier: "experimental", note: "AutoPrompt trigger threshold" },
    ],
  },
];
